...
<section class="details">
  ...
  <article class="details__info">
    ...
    <form method="post" action="index.php?page=cart">
        <p class="error"></p>
        <input type="number" value="<?php if(!empty($_SESSION['cart']['quantity'])){ echo $_SESSION['cart']['quantity'];} ?>" id="quantity" class="quantity-input" name="quantity" placeholder="1" min=1 max=10><br><br>
